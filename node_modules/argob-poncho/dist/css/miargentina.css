...
.search-group.input-group .form-group{margin-top:0px !important;}

.flex-title{
	display: flex;
	align-items: flex-start;
}
.flex-title .round-tab{margin-top: 10px;}
...
.nav-header-dashboard .btn-link i,
.nav-header-dashboard .btn-link span  {
  color:#fff;
}
...
.nav-header-dashboard .btn.btn-link.dropdown-toggle:hover,
.nav-header-dashboard .btn.btn-link.dropdown-toggle:active,
.nav-header-dashboard .btn.btn-link.dropdown-toggle:focus {
	background: rgba(255, 255, 255, 0.25) !important;
}

.nav-header-dashboard .btn.btn-link.dropdown-toggle:hover .btn-link i,
.nav-header-dashboard .btn.btn-link.dropdown-toggle:hover .btn-link span,
.nav-header-dashboard .btn.btn-link.dropdown-toggle:active .btn-link i,
.nav-header-dashboard .btn.btn-link.dropdown-toggle:active .btn-link span,
.nav-header-dashboard .btn.btn-link.dropdown-toggle:focus .btn-link i,
.nav-header-dashboard .btn.btn-link.dropdown-toggle:focus .btn-link span  {
	color: #333 !important;
}
...
.main-footer img.image-responsive-center {
	margin-bottom: 20px;
	margin-left: auto;
	margin-right: auto;
	max-width: 250px;
...
.footer img.image-responsive-center {
  margin-bottom: 20px;
	margin-left: auto;
  margin-right: auto;
  max-width: 200px;
...
.page-sidebar .nav-stacked>li+li {
	margin-top: 0 !important;
}
...
.panel-documento .panel-heading a {
	display: inline-block;
	color: #333 !important;
	outline: 0;
	padding-bottom: 20px;
...
.panel-documento .media-left img {
	width: 32px;
}

.panel-documento .media-left {
	padding-right: 15px;
}
...
.panel-documento>.panel-collapse {
	border-top: solid 1px #ddd !important;
}
...
/* .panel-nolink h3 {font-size:16px !important;font-weight:500 !important;} */


.panel-credenciales h2 {
...
.list-turnos i {
	color: #9ED7D3 !important;
}
.list-tramites i {
	color: #C2BADA !important;
}
...
.panel-list-group .list-group-item p.lead {
	margin-bottom: 5px !important;
}

.panel-list-group .list-group-item  .media-left {
...
.panel-list-group .list-group-item p:last-child {
	margin-bottom: 0 !important;
}
...
.navbar-header a i {
	padding: 11px 20px 8px 0px !important;
	float: left !important;
}
...
.sidebar-mobile {
	...
	z-index: 99;
	height: 100% !important;
	transition: left 0.3s cubic-bezier(0, 0.99, 0.36, 1);
}
...
.navbar .btn {
  ...
  @media screen and (max-width: 490px) {
	...
	.navbar-header a i {
		font-size: 16px;
		padding: 9px 12px 2px 0 !important;
		top: 3px;
		position: relative;
		margin-right: 0 !important;
...
a.btn-collapse.collapsed .text-right i {
...
@media screen and (max-width: 490px) {
	...
	.header-login .navbar-header img {
		height: 30px;
	}
}
...
.text-naranja {
	color: #FAC383 !important;
}




.collapsed {border-bottom:0 !important;}
